...
@Disabled
class Dob_2Driver extends LinearOpMode {
    ...
    boolean booly7=false;
    boolean booly8=false;
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            /**SERVO 1
             * BUTON BK*/
            if((gamepad2.back==true)&&(booly1==false)) {booly2=true;}
            if(booly2==true) {
                servo1.setPosition(0.52);
            }
            if((gamepad2.back==false)&&(booly2==true)) {booly1=true;}
            if((gamepad2.back==true)&&(booly1==true)) {booly2=false;}
            if(booly2==false) {
                servo1.setPosition(0);
            }
            if((gamepad2.back==false)&&(booly2==false)) {booly1=false;}
            ...
            /**BRAT*/
            /*if((gamepad2.left_bumper==true)&&(booly1==false)) {booly2=true;}
            if(booly2==true) {
                ServoArm.setPosition(0.4);
            }
            if((gamepad2.left_bumper==false)&&(booly2==true)) {booly1=true;}
            if((gamepad2.left_bumper==true)&&(booly1==true)) {booly2=false;}
            if(booly2==false) {
                ServoArm.setPosition(0);
            }
            if((gamepad2.left_bumper==false)&&(booly2==false)) {booly1=false;}*/
            if(gamepad2.left_bumper) if(bratpos<0.6) bratpos=bratpos+0.05;



            if((gamepad2.a==true)&&(booly3==false)) {booly4=true;}
            if(booly4==true) {
                ServoClaw.setPosition(1);
            }
            if((gamepad2.a==false)&&(booly4==true)) {booly3=true;}
            if((gamepad2.a==true)&&(booly3==true)) {booly4=false;}
            if(booly4==false) {
                ServoClaw.setPosition(0);
            }
            if((gamepad2.a==false)&&(booly4==false)) {booly3=false;}

            if(gamepad2.x && !paletaThread.isAlive())
                paletaThread.start();
            ...
            /**BIND PT MISCARE FINA FATA-SPATE-LATERAL
             * G1 BUTON D-PAD*/
            if (gamepad1.dpad_up){
            ...
            if(ls==1) telemetry.addData("POWER","1");
            if(ls==0.95) telemetry.addData("POWER","0.95");
            ...
            telemetry.addData("Gamepad_2 B -","launcher motor");
            telemetry.addData("Gamepad_2 Y -","ramp motor");
            telemetry.addData("Gamepad_2 X -","servo motor");
