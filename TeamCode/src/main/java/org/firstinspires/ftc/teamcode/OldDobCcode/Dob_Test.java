...
@Disabled
//@TeleOp(name="Dob_Test", group="Linear Opmode")
public class Dob_Test extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if(booly200==true) {
                ...
                FRmotor.setPower(gamepad1.left_stick_y*(-1)+gamepad1.right_stick_x*(-1));
                BRmotor.setPower(gamepad1.left_stick_y*(-1)+gamepad1.right_stick_x*(-1));
                FLmotor.setPower(gamepad1.left_stick_y*(-1)+gamepad1.right_stick_x*(1));
                BLmotor.setPower(gamepad1.left_stick_y*(-1)+gamepad1.right_stick_x*(1));
            ...
            if(booly200==false) {
                ...
                FRmotor.setPower(gamepad1.left_stick_y*(-1)+gamepad1.left_stick_x*(-1));
                BRmotor.setPower(gamepad1.left_stick_y*(-1)+gamepad1.left_stick_x*(-1));
                FLmotor.setPower(gamepad1.left_stick_y*(-1)+gamepad1.left_stick_x*(1));
                BLmotor.setPower(gamepad1.left_stick_y*(-1)+gamepad1.left_stick_x*(1));
            }
            ...
            else {FRmotor.setPower(0);                    /**RESETARE VALORI*/
            BRmotor.setPower(0);
            FLmotor.setPower(0);
            BLmotor.setPower(0);}
